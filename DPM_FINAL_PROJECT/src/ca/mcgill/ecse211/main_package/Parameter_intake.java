...
public class Parameter_intake {
	...
	public int Red_LL_x = 6;		//x coordinate of lower left hand corner of Red Zone
	...
	public int Green_UR_x = 2;		//x coordinate of upper right hand corner of Green Zone
	public int Green_UR_y = 5;		//y coordinate of upper right hand corner of Green Zone
	...
	public int BR_LL_x = 2;			//x coordinate of lower left corner of the bridge footprint
	public int BR_LL_y = 4;			//y coordinate of lower left corner of the bridge footprint
