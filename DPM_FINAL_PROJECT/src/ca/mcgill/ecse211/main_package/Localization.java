...
/**
 * This class is used to perform localization using both the UltraSonic and
 * light sensors. It allows the robot to now its position and orientation and
 * therefore correct itself accordingly.
 */
public class Localization {
	...
	/**
	 * Method to find the right orientation (0 degree) after light sensor
	 * localization
	 */
	...
	/**
	 * Method to get the angle between two different angle readings, even when
	 * overlapping happens
	 * 
	 * @param a
	 * @param b
